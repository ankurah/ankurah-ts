// PROVIDED: Hand-written error types — used as error types in provided impls with factory methods.
// The transpiler never overwrites this file. Generated error.ts re-exports these types.
/**
